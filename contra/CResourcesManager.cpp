...
{
	music_menu_bg = m_audio->LoadSound(const_cast<char*>(PATH_MUSIC_MENU_BG));
}
...
{
	music_map1_bg = m_audio->LoadSound(const_cast<char*>(PATH_MUSIC_MAP1_BG));
	music_map2_bg = m_audio->LoadSound(const_cast<char*>(PATH_MUSIC_MAP2_BG));
	music_map3_bg = m_audio->LoadSound(const_cast<char*>(PATH_MUSIC_MAP3_BG));


	sound_enemy_attacked = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_ENEMY_ATTACKED));
	sound_bill_1up = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_BILL_1UP));
	sound_bill_dead = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_BILL_DEAD));
	sound_boss_dead = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_BOSS_DEAD));
	sound_stage_clear = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_STAGE_CLEAR));
	sound_get_item = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_GET_ITEM));
	sound_bullet_default = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_BULLET_DEFALUT));
	sound_bullet_m = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_BULLET_M));
	sound_bullet_s = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_BULLET_S));
	sound_bullet_l = m_audio->LoadSound(const_cast<char*>(PATH_SOUND_BULLET_L));
...
{
	music_gameover_bg = m_audio->LoadSound(const_cast<char*>(PATH_MUSIC_GAMEOVER_BG));
}
...
{
	music_win_bg = m_audio->LoadSound(const_cast<char*>(PATH_MUSIC_WIN_BG));
}
